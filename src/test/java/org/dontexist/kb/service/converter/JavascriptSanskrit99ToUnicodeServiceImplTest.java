...
public class JavascriptSanskrit99ToUnicodeServiceImplTest {
    ...
    private void verify(final Character sanskrit99InputChar, final Character expected) throws Exception {
    ...
    @Test
    @Ignore
    public void testConvert_158() throws Exception {
        // PASS THRU
        verify((char) 158, (char) 158);
    }
    
    @Test
    @Ignore
    public void testConvert_157() throws Exception {
        // PASS THRU
        verify((char) 157, (char) 157);
    }
    ...
    public void testConvert_156() throws Exception {
        // HALF-GLYPH
        verify((char) 156, ""); // virama, used e.g. with D
    }
